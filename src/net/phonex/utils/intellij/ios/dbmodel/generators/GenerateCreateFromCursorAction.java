...
public class GenerateCreateFromCursorAction extends AnAction {
    private static final String TITLE = "Select Fields for createFromCursor";
    private static final String LABEL_TEXT = "Fields to include createFromCursor:";
