...
public class GenerateGetContentValuesAction extends AnAction {
    private static final String TITLE = "Select Fields for getContentValues";
    private static final String LABEL_TEXT = "Fields to include in getContentValues:";
